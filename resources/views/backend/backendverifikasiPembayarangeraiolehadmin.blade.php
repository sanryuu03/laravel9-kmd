          ...
          <div class="container-fluid">
              <form method="post" action="{{ route('backend.verifikasi.pembayaran.gerai.store', $backendGerai->id) }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <br />
                      <img class="rounded-circle" width="300px" height="300px" src="{{ url('/storage/assets/backendVerifikasiPembayaranGerai/slipPembayaran/'. $backendVerifikasiPembayaranGerai->picture_path_slip_pembayaran) }}">
                  ...
                  <a class="btn btn-danger mt-3" href="{{ route('backend.pendaftar.gerai.baru') }}">Back</a>
                  <button type="submit" class="btn btn-warning mt-3" name="action" value="proses">Proses</button>
                  <button type="submit" class="btn btn-danger mt-3" name="action" value="ditolak">Ditolak</button>
                  <a class="btn btn-success mt-3" href="{{ route('approve.pembayaran.gerai.baru', $backendGerai->id) }}">Diterima</a>
              </form>
          </div>
      </div>
  </div>
