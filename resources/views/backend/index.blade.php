  ...
  <div class="container-fluid" id="container-wrapper">
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Backend <small>Komunitas Mitra Desa</small></h1>
          <ol class="breadcrumb">
  ...
  <div class="container-fluid">
      <div class="card-body">
          <div class="row mb-3">
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                  <div class="card h-100">
                      <a href="{{  url('/backendGerai/geraiDalamProses') }}" class="d-flex">
                      <div class="card-body">
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                  <div class="card h-100">
                      <a href="{{  url('/backendGerai/geraiDitolak') }}" class="d-flex">
                      <div class="card-body">
                          <div class="row no-gutters align-items-center">
                              <div class="col mr-2">
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                  <div class="card h-100">
                      <a href="{{  url('/backendGerai/geraiDiterima') }}" class="d-flex">
                          <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                  <div class="col mr-2">
